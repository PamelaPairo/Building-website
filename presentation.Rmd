...
+ _**menus.toml**_: opciones del menú de navegación (Notas, Proyectos, Cursos, Publicaciones, etc). 
...
To show that the personal website is multilingual, it is convenient to go to **params.toml** and verify that the _show_language= TRUE_
...
- Creando una página web bilinguee
